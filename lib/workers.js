...
workers.validateCheckData = function (originalCheckData) {
  ...
  // Set the keys that may not to be set (if the workers have never seen this check before)
...
// Proccess the check outcome, update the check data as needed, trigger an alert if needed
// Special logic for accomodating a check that has never been tested before (don't alert on that one)
workers.processCheckOutcome = function (originalCheckData, checkOutcome) {
  // debug("checkOutcome: ", checkOutcome);
...
// Alert the user as to a change in their chaeck status
...
workers.log = function (
  ...
  // Determine the name os the log file
...
workers.init = function () {
  ...
  console.log("\x1b[33m%s\x1b[0m", "Background workers are running"); // 33:yellow
